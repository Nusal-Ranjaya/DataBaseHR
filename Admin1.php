...
<body style="border-width: 0px;display: block;background: linear-gradient(0deg, #00d7ff 0%, white 89%), #00D7FF;height: auto;">
    ...
    <h1 style="margin-top: 20px;margin-bottom: 10px;text-align: center;border-style: none;">Admin</h1>
    <section>
        <div></div>
    </section>
    <div class="container">
    ...
    <div class="row" style="width: 500px;position: static;display: inline;padding-right: 40px;padding-left: 50px;">
        <div class="col d-lg-flex flex-grow-1 justify-content-lg-center">
            <div class="container d-sm-flex d-lg-flex justify-content-sm-center justify-content-lg-center" style="height: 450px;max-width: 550px;margin-top: 40px;background: var(--bs-body-bg);border-color: var(--bs-btn-active-color);border-radius: 12px;">
                <div class="row" style="margin-top: 20px;margin-bottom: 20px;">
                    <div class="col" style="margin-top: 0px;margin-bottom: 0px;height: 400px;">
                        <div class="row">
                            <div class="col" style="margin-top: 20px;"><a href="update_Employee.php"><button class="btn btn-primary" type="button" style="border-radius: 13px;max-width: 300px;width: 300px;margin-top: 15px;margin-bottom: 50px;" data-bs-target="untitled.html">Update User</button></a></div>
                        </div>
                        <div class="row">
                            <div class="col"><a href="Add_HR.html"><button class="btn btn-primary" type="button" style="border-radius: 13px;max-width: 300px;width: 300px;margin-top: 20px;margin-bottom: 50px;">Add Management Account</button></a></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col" style="margin-top: 20px;"><a href="Add_Attribute.php"></a><a class="btn btn-primary" type="button" style="border-radius: 13px;max-width: 300px;width: 300px;margin-top: 20px;margin-bottom: 30px;" href="Add_Attribute.php">Add New Custom Employee Attribute</a></div>
                        </div>
                    </div>
                </div>
            </div>
