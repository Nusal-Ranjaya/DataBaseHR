                                            ...
                                            <tr>
                                                <?php    
                                                     if(isset($_POST['department'])){
                                                        ...
                                                        if($department=='All'){
                                                            $query = "SELECT ID,first_name,last_name,title_id,dept_name from personal_data NATURAL join employee";
                                                        }
                                                        else{
                                                            $query = "SELECT ID,first_name,last_name,title_id,dept_name from personal_data NATURAL join employee WHERE employee.dept_name = '$department'";
                                                        }
